...
$(document).on('click', '.editArticle' , function() {
	...
	var csrf_token = $('meta[name="csrf-token"]').attr('content');
	 $.ajax({
        type: "POST",
		dataType: 'json',
        url: base_url+'/article/edit/'+article_id,
        data: {_token:csrf_token,article_id:article_id},
        success: function(data) {
			if(data.success){
			
				$('.articleEditModal').html(data.data);
...
$(document).on('click', '.editTemplate' , function() {
	...
	var csrf_token = $('meta[name="csrf-token"]').attr('content');
	 $.ajax({
        type: "POST",
		dataType: 'json',
        url: base_url+'/template/edit/'+template_id,
        data: {_token:csrf_token,template_id:template_id},
        success: function(data) {
			if(data.success){
			
				$('.templateEditModal').html(data.data);
...
/*==============================================
	SHOW EDIT Infographic FORM 
============================================*/
$(document).on('click', '.editInfographic' , function() {
	
	var infographic_id = $(this).data('infographic_id');
	var csrf_token = $('meta[name="csrf-token"]').attr('content');
	 $.ajax({
        type: "POST",
		dataType: 'json',
        url: base_url+'/infographic/edit/'+infographic_id,
        data: {_token:csrf_token,infographic_id:infographic_id},
        success: function(data) {
			if(data.success){
			
				$('.infographicEditModal').html(data.data);
				$('.infographicEditModal').modal('show');
				/* var selectedVal = $('#district_selected').val();
				var  state = $('#state').val();
				if(state != ''){
					getCityDropDown(state);
...
$(document).on('click', '.editform' , function() {
	...
	var csrf_token = $('meta[name="csrf-token"]').attr('content');
	 $.ajax({
        type: "POST",
		dataType: 'json',
        url: base_url+'/form/edit/'+form_id,
        data: {_token:csrf_token,form_id:form_id},
        success: function(data) {
			if(data.success){
			
				$('.formEditModal').html(data.data);
