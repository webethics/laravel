    ...
    */
	 ...
	 protected function register(CreateUserRequest $request)
    {
		  ...
		  //SEND EMAIL TO REGISTER USER.
			...
			$result = EmailTemplate::where('template_name','user_register')->get();
			...
			$subject1 = "A new user registered";
			$mail = send_email('info@namoothaj.net', $subject, $message);
			
			return Response::json(array(
				  'success'=>true,
				  'message'=> trans('authentications.signup.successMeassge')
