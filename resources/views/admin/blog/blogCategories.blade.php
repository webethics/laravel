...
@stop
@section('content')
@section('pageTitle', 'Blog Category')
	<div class="row">
		<div class="col-12">
			<h1>Blog Categories</h1>
			@if(check_role_access('blog_categories_create'))
				<span class="fl_right balance" style="margin-right:10px;">
					<a id="create__blog_categories" class="btn btn-primary" href="{{'/admin/blog-categories/create'}}">Create Category</a>
				</span>
			@endif
		...
		<div class="col-12 mb-4">
			...
			<div class="card">
				...
				<div class="table-responsive blogs_full"  id="tag_container">
				  	 @include('admin.blog.blogCategoriesPagination')
				</div>
				</div>
			</div>
