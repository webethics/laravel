...
@endsection
@section('pageTitle', $blogTitle.'  Blog Category')  
					...
					<div class="box box-primary">
						<div class="box-body">
							@include('flash-message')	
					        	...
					        	@if($newBlog == 1)
									{{ Form::open(array('url' => 'admin/blog-categories/create', 'method' => 'post','class'=>'profile form-horizontal','enctype'=>'multipart/form-data')) }}
								@else
