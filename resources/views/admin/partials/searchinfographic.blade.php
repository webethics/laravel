		...
		<div class="card-body">
			...
			<div class="row">
				<div class="form-group col-lg-6">
					...
					<button type="button" id="export_infographics" class="btn btn-primary default  btn-lg mb-2 mb-lg-0 col-12 col-lg-auto">Export Infographics</button>
					<!--<span class="fl_right balance"><a id="export_infographics" class="btn btn-primary" href="javascript:void(0)">Export Infographics</a></span>
