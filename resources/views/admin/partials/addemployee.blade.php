  ...
  <div class="card-body">
      <div class="row" id="tag_container">
          <div class="box box-primary">
              <div class="box-body">
                  <form method="POST"  accept-charset="UTF-8" class="profile form-horizontal" id="add_employee_form">
                            ...
                            <div class="col row col-md-6">
                                  ...
                                  <div class="col-md-12 col-xs-12 field mb-4">
                                      <label for="Sale Item No">EMP ID</label>
                                          <input class="form-control" id="emp_id" placeholder="Employee ID"  name="emp_id" type="text" >	
                                  ...
                                  <div class="col-md-12 col-xs-12 field mb-4">
                                      <label for="title">Name</label>
                                          <input class="form-control" placeholder="Name" name="emp_name" type="text"  id="emp_name">
                                          <span class="text-danger" id="emp_name-error"></span>	
                                  </div>
                                                       <!--  Father Name-->
                                  <div class="col-md-12 col-xs-12 field mb-4">
                                      <label for="title">Father Name</label>
                                          <input class="form-control" placeholder="Father-Name" name="father_name" type="text"  id="father_name">
                                  ...
                                  <div class="col-md-12 col-xs-12 field mb-4" >
                                      <label for="Personal_Email">Personal Email </label>
                                          ...
                                          <input class="form-control" placeholder="Personal Email" name="personal_email" type="email"  id="personal_email">
                                   ...
                                   <div class="col-md-12 col-xs-12 field mb-4" id="Professional_Email">
                                      <label for="Professional_Email" id="label_email">Professional Email  </label>
                                          <input class="form-control" placeholder="Professional_Email" name="professional_email" id="professional_email" type="email" >
