                ...
                <div class="col-12 col-md-8 col-lg-6 mx-auto my-auto">
					...
					@else
						 <h1>
                                ...
                                <div class="" style="font-size:14px">This link is not working any more.Please click <strong><a href="{{url('/admin/forgot-password')}}" >Here</a></strong> to reset password </div>
