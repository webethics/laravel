							...
							<div class="form-group col-md-12">
								<div class="row">
									<div class="col-md-8 row col-xs-12">
										...
										{{ Form::text('arabic_title',$data->arabic_title,array('class'=>'form-control','placeholder'=>'')) }}
										...
										<div class="col-md-12 col-xs-12 field mb-4">
											...
											{{ Form::textarea('arabic_content',$data->arabic_content,array('class'=>'form-control','placeholder'=>'')) }}
