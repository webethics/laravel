...
@section('content')
@section('pageTitle','Create Settings')
				...
				<div class="card-body">
					...
					<form name="site_settings" id="site_settings" data-id="{{$user_id}}" enctype="multipart/form-data">					
						...
						<div class="form-group">
							...
							<div class="d-flex control-group">
								<input type="text"  name="social_facebook" id="social_facebook" value="{{$settings->social_facebook}}" class="form-control">
							</div>
							<div class="social_facebook_error errors"></div>
						</div>

						<div class="form-group">
							<label class="col-form-label">Twitter</label>
							<div class="d-flex control-group">
								<input type="text"  name="social_twitter" id="social_twitter" value="{{$settings->social_twitter}}" class="form-control">
							</div>
							<div class="social_twitter_error errors"></div>
						</div>

						<div class="form-group">
							<label class="col-form-label">Instagram</label>
							<div class="d-flex control-group">
								<input type="text"  name="social_instagram" id="social_instagram" value="{{$settings->social_instagram}}" class="form-control">
							</div>
							<div class="social_instagram_error errors"></div>
						</div>
