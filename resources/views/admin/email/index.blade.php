...
<div class="row">
	<div class="col-12"> 
		<h1>Emails</h1>
		@if(check_role_access('email_create'))
				<span class="fl_right balance"><a id="create_email" class="btn btn-primary" href="{{'/admin/emails/create'}}">Create Email template</a></span>
			@endif
