...
<div id="editbug" tabindex="-1"  class="modal fade modal-right" role="dialog">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-row mt-4">
						<div class="col-md-12">
							...
							<button type="submit" class="btn btn-primary default btn-lg mb-2 mb-sm-0 mr-2 col-12 col-sm-auto">{{ trans('global.update') }}</button>
